...
@Slf4j
public class RefundValidators implements Validator {
    ...
    private void nullOrEmptyCheckRetrieveMany(final CyberSourceRequest request, final Errors errors) {
        FieldValidationUtils.nullOrEmptyCheck(errors, request.getClientReferenceInformation(), "clientReferenceInformation");
        FieldValidationUtils.nullOrEmptyCheck(errors, request.getOrderInformation(), "orderInformation");
    }
}
